  ...
  CameraTag = new function() {
    ...
    CameraTagRecorder = function(camera_el) {
      ...
      var embedSWF = function() {
        ...
        swfobject.embedSWF("/camera.swf?"+cachebuster, dom_id+"_swf_placeholder", "100%", "100%", '11.1.0', 'https://'+appServer+'/'+CameraTag.version+'/expressInstall.swf', flashvars, params, attributes, checkSWF);
      ...
      var create_uploader = function(browse_element) {
        ...
        upload_input = $('<input id="upload_file" style="position:absolute; opacity:.01;" type="file" accept="video/mp4,video/m4v,video/x-flv,video/flv,video/wmv,video/mpg,video/quicktime,video/webm,video/x-ms-wmv,video/ogg,video/avi,video/mov,video/x-m4v,video/*" capture>')
